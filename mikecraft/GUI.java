...
public class GUI {
	public static void drawBackground(){
		...
		glBegin(GL_QUADS);
		glTexCoord2f(0, -1);
	    glVertex2i(Width / 2 - 128, Height / 2 - 100); // Upper-left
	    glTexCoord2f(1, -1);
	    glVertex2i(Width / 2 + 128, Height / 2 - 100); // Upper-right
	    glTexCoord2f(1, 0);
	    glVertex2i(Width / 2 + 128, Height / 2 - 190); // Bottom-right
	    glTexCoord2f(0, 0);
	    glVertex2i(Width / 2 - 128, Height / 2 - 190); // Bottom-left
		glEnd();}
	}
}
