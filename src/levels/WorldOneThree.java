...
public class WorldOneThree extends Gravity 
{
	...
	private static void drawBackground() 
	{
		...
		ground[2] = new World.Ground(Dirt, Width * 2 + BlockSize * 2, BlockSize * 2, BlockSize * 2, Width * 2);
		ground[3] = new World.Ground(Dirt, Width * 4 + BlockSize * 2, BlockSize, BlockSize * 2, Width);
		ground[4] = new World.Ground(Dirt, Width * 5 + BlockSize * 2, BlockSize * 2, BlockSize * 2, Width * 5);
